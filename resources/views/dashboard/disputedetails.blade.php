            ...
            <div class="col-md-8 mx-auto mb-4">
                <div class="card text-left">
                    ...
                    <div class="card-body">
                            ...
                            @foreach ($details as $key => $detail)
                                @if ($key == 'dispute_status')
                                    <tr>
                                        ...
                                        <td>
                                            @if ($detail == 1)
                                                <span class="badge badge-success pr-3 pl-3 pt-2 pb-2">Resolved <i
                                                        class="fa fa-check" aria-hidden="true"></i> </span>
                                            @else
                                                <span class="badge badge-danger pr-3 pl-3 pt-2 pb-2">Unresolved <i
                        ...
                        @if ($details['dispute_status'] == 0)
                            <button type="button" class="btn btn-outline-success mb-3" data-toggle="modal"
                                data-target="#exampleModal">Resolve dispute <i class="fa fa-pencil-square"
